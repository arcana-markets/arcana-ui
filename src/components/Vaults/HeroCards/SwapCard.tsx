...
const SwapCard = () => {
  return (
<div className="relative pt-10 pb-4 sm:py-10 mx-auto max-w-lg">
  <div className="rounded-3xl relative z-10 group bg-darkblue duration-500 hover:shadow-light-blue sm:px-6 sm:pb-4 sm:pt-8 pt-10 p-4 overflow-hidden mx-auto">
        <Image
