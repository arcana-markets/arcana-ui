        ...
        <div className="border-t border-l border-r p-2 mb-1 flex flex-col md:flex-row items-center cardShadowBor rounded-t-[16px] bg-[#012732] dark:bg-[#012732]">
            ...
            <div className="flex flex-wrap justify-around items-center w-full mt-4 md:mt-0 md:flex-basis[70%]">
                ...
                <div className="flex flex-col items-center cursor-default">
                    ...
                    <div className={`text-xs ${typeof marketData?.marketPerformance?.minute30 === 'number' && marketData?.marketPerformance?.minute30 > 0 ? 'text-success-100' : marketData?.marketPerformance?.minute30 < 0 ? 'text-danger-100' : 'text-foreground-100 opacity-50'}`}>
                        {typeof marketData?.marketPerformance?.minute30 === 'number' ? marketData.marketPerformance.minute30.toFixed(2) : '0.00'}%
                    </div>
                </div>
                <div className="flex flex-col items-center cursor-default">
                    <div className="text-xs text-foreground-100">1h</div>
                    <div className={`text-xs ${typeof marketData?.marketPerformance?.hour1 === 'number' && marketData?.marketPerformance?.hour1 > 0 ? 'text-success-100' : marketData?.marketPerformance?.hour1 < 0 ? 'text-danger-100' : 'text-foreground-100 opacity-50'}`}>
                        {typeof marketData?.marketPerformance?.hour1 === 'number' ? marketData.marketPerformance.hour1.toFixed(2) : '0.00'}%
                    </div>
                </div>
                <div className="flex flex-col items-center cursor-default">
                    <div className="text-xs text-foreground-100">4h</div>
                    <div className={`text-xs ${typeof marketData?.marketPerformance?.hour4 === 'number' && marketData?.marketPerformance?.hour4 > 0 ? 'text-success-100' : marketData?.marketPerformance?.hour4 < 0 ? 'text-danger-100' : 'text-foreground-100 opacity-50'}`}>
                        {typeof marketData?.marketPerformance?.hour4 === 'number' ? marketData.marketPerformance.hour4.toFixed(2) : '0.00'}%
                    </div>
                </div>
                <div className="flex flex-col items-center cursor-default">
                    <div className="text-xs text-foreground-100">24h</div>
                    <div className={`text-xs ${typeof marketData?.marketPerformance?.hour24 === 'number' && marketData?.marketPerformance?.hour24 > 0 ? 'text-success-100' : marketData?.marketPerformance?.hour24 < 0 ? 'text-danger-100' : 'text-foreground-100 opacity-50'}`}>
                        {typeof marketData?.marketPerformance?.hour24 === 'number' ? marketData.marketPerformance.hour24.toFixed(2) : 'N/A'}%
                    </div>
                </div>
            </div>
        </div>
