...
const SwapWidget = () => {
  ...
  return (
    <div className={`relative w-full min-w-[400px] max-w-[400px] flex flex-col bg-coarsewool rounded-[16px] pt-2 sm:pt-4 z-0`}>
      ...
      <div key={refreshKey} id="integrated-terminal" className='w-full p-4 rounded-md'></div>
